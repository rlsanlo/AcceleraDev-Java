...
public class DesafioMeuTimeApplicationSimpleTest {
    ...
    @Test
    public void deveIncluirTimeQueNaoExiste() throws IdentificadorUtilizadoException {
    ...
    @Test
    public void deveIncluirJogadorNaoExistenteEmTimeJaExistente() throws IdentificadorUtilizadoException, TimeNaoEncontradoException {
        final DesafioMeuTimeApplication desafioMeuTimeApplication = new DesafioMeuTimeApplication();
        desafioMeuTimeApplication.incluirTime(1l, "Teste1", LocalDate.now(), "branco", "branco");
    ...
    @Test
    public void deveDefinirCapitao() throws IdentificadorUtilizadoException, TimeNaoEncontradoException, JogadorNaoEncontradoException, CapitaoNaoInformadoException {
        final DesafioMeuTimeApplication desafioMeuTimeApplication = new DesafioMeuTimeApplication();
        desafioMeuTimeApplication.incluirTime(1l, "Teste1", LocalDate.now(), "branco", "branco");
        desafioMeuTimeApplication.incluirJogador(1l, 1l, "Jogador", LocalDate.now(), 1, BigDecimal.TEN);
    ...
    @Test
    public void deveBuscarNomeJogador() throws IdentificadorUtilizadoException, TimeNaoEncontradoException, JogadorNaoEncontradoException {
        final DesafioMeuTimeApplication desafioMeuTimeApplication = new DesafioMeuTimeApplication();
        desafioMeuTimeApplication.incluirTime(1l, "Teste1", LocalDate.now(), "branco", "branco");
        desafioMeuTimeApplication.incluirJogador(1l, 1l, "Jogador", LocalDate.now(), 1, BigDecimal.TEN);
    ...
    @Test
    public void deveBuscarNomeTime() throws IdentificadorUtilizadoException, TimeNaoEncontradoException {
        final DesafioMeuTimeApplication desafioMeuTimeApplication = new DesafioMeuTimeApplication();
        desafioMeuTimeApplication.incluirTime(1l, "Teste1", LocalDate.now(), "branco", "branco");
    ...
    @Test
    public void deveBuscarJogadoresDoTime() throws IdentificadorUtilizadoException, TimeNaoEncontradoException {
        final DesafioMeuTimeApplication desafioMeuTimeApplication = new DesafioMeuTimeApplication();
        desafioMeuTimeApplication.incluirTime(1l, "Teste1", LocalDate.now(), "branco", "branco");
    ...
    @Test
    public void deveBuscarMelhorJogadorDoTime() throws IdentificadorUtilizadoException, TimeNaoEncontradoException {
        final DesafioMeuTimeApplication desafioMeuTimeApplication = new DesafioMeuTimeApplication();
        desafioMeuTimeApplication.incluirTime(1l, "Teste1", LocalDate.now(), "branco", "branco");
        desafioMeuTimeApplication.incluirJogador(2l, 1l, "Jogador", LocalDate.now(), 1, BigDecimal.TEN);
    ...
    @Test
    public void deveBuscarJogadorMaisVelho() throws TimeNaoEncontradoException, IdentificadorUtilizadoException {
        final DesafioMeuTimeApplication desafioMeuTimeApplication = new DesafioMeuTimeApplication();
        desafioMeuTimeApplication.incluirTime(1l, "Teste1", LocalDate.now(), "branco", "branco");
    ...
    @Test
    public void deveBuscarTodosOsTimesExistentes() throws IdentificadorUtilizadoException {
        final DesafioMeuTimeApplication desafioMeuTimeApplication = new DesafioMeuTimeApplication();
        desafioMeuTimeApplication.incluirTime(1l, "Teste1", LocalDate.now(), "branco", "branco");
    ...
    @Test
    public void deveBuscarJogadorComMaiorSalarioDoTime() throws IdentificadorUtilizadoException, TimeNaoEncontradoException {
        final DesafioMeuTimeApplication desafioMeuTimeApplication = new DesafioMeuTimeApplication();
        desafioMeuTimeApplication.incluirTime(1l, "Teste1", LocalDate.now(), "branco", "branco");
    ...
    @Test
    public void deveRetornarSalarioDoJogador() throws IdentificadorUtilizadoException, TimeNaoEncontradoException, JogadorNaoEncontradoException {
        final DesafioMeuTimeApplication desafioMeuTimeApplication = new DesafioMeuTimeApplication();
        desafioMeuTimeApplication.incluirTime(1l, "Teste1", LocalDate.now(), "branco", "branco");
        desafioMeuTimeApplication.incluirJogador(2l, 1l, "Jogador", LocalDate.now().minus(25, ChronoUnit.YEARS), 1, new BigDecimal(10000));
        desafioMeuTimeApplication.incluirJogador(3l, 1l, "Jogador2", LocalDate.now().minus(20, ChronoUnit.YEARS), 2, new BigDecimal(20000));
    ...
    @Test
    public void deveRetonarTopJogadores() throws TimeNaoEncontradoException, IdentificadorUtilizadoException {
        final DesafioMeuTimeApplication desafioMeuTimeApplication = new DesafioMeuTimeApplication();
        desafioMeuTimeApplication.incluirTime(1l, "Teste1", LocalDate.now(), "branco", "branco");
        desafioMeuTimeApplication.incluirJogador(2l, 1l, "Jogador", LocalDate.now().minus(25, ChronoUnit.YEARS), 1, new BigDecimal(10000));
        desafioMeuTimeApplication.incluirJogador(3l, 1l, "Jogador2", LocalDate.now().minus(20, ChronoUnit.YEARS), 2, new BigDecimal(20000));
